...
class RestaurantTest < Minitest::Test
  ...
  def test_closing_time_announcement
    ...
    assert_equal "Fuel Cafe is closing at 3:00PM", restaurant1.announce_closing_time(5)
    assert_equal "Il Poggio is closing at 11:00PM", restaurant2.announce_closing_time(7)
